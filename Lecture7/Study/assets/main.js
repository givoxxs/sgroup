...
//         if (check > 0) {
//             return `Có 2 nghiệm phân biệt là ${x1.toFixed(4)} va ${x2.toFixed(4)}`
//         } else if (check < 0) {
//             return `Vo nghiem`
//         } else if (check == 0) {
//             return `Có nghiệm duy nhất la ${x1.toFixed(4)}`
//         }
//     } else {
//         if (b != 0) {
...
function findTheNextDay(day, month, year) {
    ...
    if (!month_true(month) || !day_true(day)) return 'Ngay thang nam khong phu hop!'

    if (day <= 28) {
        return `Ngay tiep theo la ${day+1} / ${month} / ${year}`
    } else if (day == 28) {
        if (month == 2) {
            if (!checkNamNhuan(year)) 
                return `Ngay tiep theo la ${1} / ${month + 1} / ${year}`
        } else {
           return `Ngay tiep theo la ${day+1} / ${month} / ${year}`
        }
    } else if (day == 29) {
        if (month == 2) {
            if(checkNamNhuan(year)) {
                ...
                return 'Ngay thang nam khong phu hop!'
            }
        } else {
            return `Ngay tiep theo la ${1} / ${month + 1} / ${year}`
        }
        ...
        if(month == 2) return 'Ngay thang nam khong phu hop!'
        ...
        if (checkThang12(month)) {
            return `Ngay tiep theo la ${1} / ${1} / ${year + 1}`
        } else {
            return `Ngay tiep theo la ${1} / ${month + 1} / ${year}`
        }
    } else {
